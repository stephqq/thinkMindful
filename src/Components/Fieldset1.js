    ...
    return (
        <fieldset className="fs1">
            ...
            <div>
                ...
                <input type="date" id="date" name="date" pattern="\d{4}-\d{2}-\d{2}" onChange={props.handleInputChange} />
            </div>
            <label htmlFor="situation" className="visuallyHidden">Describe situation/trigger</label>
            <textarea name="situation" id="situation" placeholder="What happened? How? Where? With who?" onChange={props.handleInputChange}></textarea>
